            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{ route('admin.pages.add') }}" class="btn btn-sm btn-brand btn-icon-sm">
...
@endsection
@push('scripts')
<script src="./assets/js/data-page-list.js" data-id="page-list-script" data-url="{{ url('/') }}" type="text/javascript"></script>
