    ...
    <div class="container mt-2 mb-5">
        <div class="row">
            <div class="col-md-8">
                ...
                <a href="{{ route('front.trips.customize', ['slug' => $trip->slug]) }}" class="print mr-3"><i
                        class="fas fa-tools"></i> Customize this trip</a>
                <a href="{{ route('front.trips.print', ['slug' => $trip->slug]) }}" class="print mr-3"> <i
                        class="fas fa-print"></i> Print tour details</a>
                @if($trip->pdfLink)
                ...
                <div id="overview" class="tour-details-section">
                    ...
                    <p class="text-center">
                        <button id="toggle-overview" class="btn btn-accent" data-toggle="collapse"
                            data-target="#overview-text">Show
                            More</button>
                    </p>
                        ...
                        <div class="itinerary-row">
                            ...
                            <div class="itinerary-text">
                                <div class="collapse-toggle">
                                    <a data-toggle="collapse" href="#day{{ $key }}" aria-expanded="false"
              ...
              <div class="col-lg-7"> -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="text-accent">USD
                                            <b>{{ number_format($departure->price) }}</b></span>
                                    </td>
                                    <td><span class="text-success">{{ $departure->statusInfo }}</span></td>
                                    <td><a href="{{ route('front.trips.departure-booking', ['slug' => $trip->slug, 'id' => $departure->id]) }}"
                                            class="btn btn-sm btn-accent">Book now</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                        <p class="text-center"><button id="more-dates" class="btn btn-accent2">See more dates</button>
                        </p>
                    </div>
                </div>
                @endif
                ...
                <div id="reviews" class="tour-details-section">
                    ...
                    @endforeach
                    <p class="text-center"><button id="more-reviews" class="btn btn-accent2">See more reviews</button>
                    </p>
                    <!-- Write a review button. Triggers modal. -->
                    <a href="#" class="btn btn-accent" data-toggle="modal" data-target="#review-modal"><i
                            class="fas fa-edit"></i>
                        Write a review</a>
                </div>
                @endif
                    ...
                    <div class="accordion" id="faq-accordion">
                        ...
                        <div class="card">
                            <div class="card-header" id="faq{{ $key }}">
                                <h1>{{ $faq->title }}</h1>
                                <a role="button" data-toggle="collapse" href="#answer{{ $key }}" class="stretched-link"
                                    aria-expanded="true">
                                </a>
                            </div>
                            <div id="answer{{ $key }}" class="collapse" data-parent="#faq-accordion"
                ...
                @endif
                <p class="mb-5">
                    <a href="{{ route('front.trips.booking', ['slug' => $trip->slug]) }}"
                        class="d-none d-md-inline-block btn btn-accent mr-3">Book Now</a>
                    <a href="{{ route('front.trips.customize', ['slug' => $trip->slug]) }}" class="print mr-3"><i
                            class="fas fa-tools"></i> Customize this trip</a>
                    <a href="{{ route('front.trips.print', ['slug' => $trip->slug]) }}" class="print mr-3"> <i
                            class="fas fa-print"></i> Print tour details</a>
                    @if($trip->pdfLink)
                    <a href="{{ $trip->pdfLink }}" download target="_blank" class="print my-2"> <i
                            class="fas fa-map"></i> Download brochure</a>
                    @endif
                </p>
            ...
            <div class="col-md-4">
                <aside>
                    <div class="card price-card mb-4">
                        ...
                        <p class="mb-3">
                            <a href="{{ route('front.trips.booking', ['slug' => $trip->slug]) }}"
                                class="btn btn-block btn-accent">Book Now</a>
                            <a href="#" class="btn btn-block btn-accent">Enquire Now</a>
                        </p>
                        <hr>
                        <div class="text">
                    ...
                    <a href="{{ route('front.trips.customize', ['slug' => $trip->slug]) }}"
                        class="btn btn-customize btn-accent2 btn-block mb-3"><i class="fas fa-tools"></i>
                        Customize this
                        trip</a>
            ...
            Price</button> -->
                    ...
                    {{-- end of map --}}
                    <button data-toggle="modal" data-target="#agency-modal"
                        class="btn btn-customize btn-accent2 btn-block mb-3"><i
                    ...
                    <div class="experts-card card">
                        ...
                        <p class="experts-phone"><a href="mailto:"><i class="fas fa-envelope"></i>
                                info@vertexholiday.com</a></p>
                    </div>
                    ...
                    <div class="package-card-sm">
                        ...
                        <div class="info">
                            ...
                            <div class="info-bottom">
                                ...
                                @if($addon_trip->cost)
                                <div class="price"><small>from</small> <br><b>USD
                                        {{ number_format($addon_trip->cost) }}</b></div>
                                @endif
                            </div>
                        </div>
