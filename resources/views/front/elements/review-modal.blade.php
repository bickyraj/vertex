<div class="modal fade" id="review-modal" tabindex="-1" role="dialog" aria-labelledby="reviewModal" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('front.reviews.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal-body">
            <div class="form-group">
              <label for="photo-input">Photo</label>
              <input type="file" name="image" class="form-control-file" id="photo-input">
            ...
            <div class="form-row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select id="country" name="review_country" class="form-control" required>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="">Package <span style="color:red;">*</span></label>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="title" required class="form-control" placeholder="Short title">
                </div>
                <div class="form-group">
              ...
              <div class="col-lg-6">
                <label for="">Review <span style="color:red;">*</span></label>
                <textarea type="text" rows="5" required name="review" class="form-control" placeholder="Review"></textarea>
              </div>
            </div>
        </div>
